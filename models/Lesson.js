...
const LessonSchema = new mongoose.Schema({
    ...
    vocabulary: {
        ...
        validate: {
            validator: function(v) {
                return v.length <= 1000; // Max 1000 words per lesson
            },
            message: 'Vocabulary cannot have more than 1000 words'
        }
    },
    ...
    gameSettings: {
        ...
        // Balloon colors for pop-the-balloon game
        balloonColors: {
...
// Index for active lessons query
