...
export async function POST(request) {
    try {
        ...
        // Generate unique filename — use extension from MIME type, not client filename
        const MIME_TO_EXT = { 'video/mp4': 'mp4', 'video/webm': 'webm', 'video/ogg': 'ogg', 'video/quicktime': 'mov' };
