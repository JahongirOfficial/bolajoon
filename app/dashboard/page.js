...
const quickActions = [
    { icon: 'UserPlus', label: "O'quvchi qo'shish", href: '/dashboard/students/add', color: '#FFE4F0', iconColor: '#FF7EB3', tour: 'add-student' },
...
export default function DashboardPage() {
    ...
    return (
        <div className="page-content">
            ...
            <main className="p-3">
                {/* Welcome Banner */}
                <div data-tour="welcome" className="card border-0 rounded-4 mb-4 overflow-hidden" style={{ background: 'linear-gradient(135deg, #FF7EB3 0%, #FF9E7D 100%)' }}>
                ...
                {/* How it works */}
                <div className="card border-0 rounded-4 bg-white" data-aos="fade-up">
                    <div className="card-body p-4">
                        ...
                        <div className="d-flex flex-column gap-3">
                            <div className="d-flex align-items-start gap-3 p-3 rounded-4" style={{ backgroundColor: '#FFE4F0' }}>
                                <div className="rounded-3 p-2 bg-white">
                                    <Video size={20} color="#FF7EB3" />
                                </div>
                                <div>
